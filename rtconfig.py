...
CPU='cortex-m33'
CROSS_TOOL='gcc'
BOARD_NAME = 'frdm-mcxa156'
BSP_LIBRARY_TYPE = 'MCXA156'
...
if PLATFORM == 'gcc':
    ...
    AFLAGS = DEVICE
    LFLAGS = DEVICE + ' --libpath "' + EXEC_PATH + '/ARM/ARMCC/lib" --info sizes --info totals --info unused --info veneers --list rtthread.map --scatter "./MCXA156_flash.scf" '
    ...
    LFLAGS = ' --config "board/linker_scripts/MCXA156_flash.icf"'
